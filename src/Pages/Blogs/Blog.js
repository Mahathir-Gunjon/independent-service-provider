        ...
        <div className='bg-black py-5'>
            <Container className='py-5'>
                ...
                <div className="card rounded-3 border-0 service-bg my-5">
                    <div className="row g-0">
                        <div className="col-md-4">
                            <img src='https://lh3.googleusercontent.com/16FwaRpvUmWs1ZfVVsYmoA4gqvNH8kazS9crLGTEZAxKKDuH6d_j_GKsqzt6WWwqHqgIJmmkYOu3Nk6QFotq5l7MdT-BpAOzoTJM8KX6ToS9SZCVIsj1v2wc5YZeg8twRuX34HER' className="img-fluid rounded-start object-fit" style={{ height: "100%" }} alt="..." />
                        </div>
                                    ...
                                    <div className="container">
                                        <div className="row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="p-3">
                                                    <h5>Authorization</h5>
                                                    <p>While in authorization method, person's or user's authorities ar checked for accessing the resources. While in this process, users or persons are validated. While this process is done after the authentication process. While it needs user's privilege or security levels.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="card rounded-3 border-0 service-bg my-5">
                    <div className="row g-0">
                        <div className="col-md-4">
                            <img src='https://pbs.twimg.com/media/D6J6pqTX4AAyA3K.jpg' className="img-fluid rounded-start object-fit" style={{ height: "100%" }} alt="..." />
                        </div>
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Why are you using firebase? What other options do you have to implement authentication?</h5>
                                <p className="card-text">
                                    we use firebase for authentication and authorization. firebase is a cloud based platform. Firebase is simple, lightweight, friendly, and industrially recognized.
                                    <br />
                                    <br />
                ...
                <div className="card rounded-3 border-0 service-bg my-5">
                    <div className="row g-0">
                        <div className="col-md-4">
                            <img src='https://www.tristatetechnology.com/tristate-website/blog/wp-content/uploads/2019/06/firebase11.jpg' className="img-fluid rounded-start object-fit" style={{ height: "100%" }} alt="..." />
                        </div>
                        <div className="col-md-8">
                            <div className="card-body">
